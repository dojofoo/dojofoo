...
The **`@dojofoo/pydantic-agents`** dojo teaches
[Pydantic](https://docs.pydantic.dev) and
[pydantic-ai](https://ai.pydantic.dev) the same way the rest of dojofoo does:
...
The dojo source lives in the [dojofoo monorepo](https://github.com/dojofoo/dojofoo/tree/main/dojos/pydantic-agents).
