...
The **`@dojofoo/effect-ts`** dojo is a 40-kata curriculum for
...
The dojo source lives in the [dojofoo monorepo](https://github.com/dojofoo/dojofoo/tree/main/dojos/effect-ts).
